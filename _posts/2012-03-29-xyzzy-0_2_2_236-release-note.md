...
{% include JB/setup %}
  ...
  * ダウンロード: [xyzzy-0.2.2.236.zip](https://github.com/downloads/xyzzy-022/xyzzy/xyzzy-0.2.2.236.zip)
    ([ソース](https://github.com/downloads/xyzzy-022/xyzzy/xyzzy-src-0.2.2.236.zip))
